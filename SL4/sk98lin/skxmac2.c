...
static const char SysKonnectFileId[] =
	"@(#) $Id: skxmac2.c,v 2.55 2006/04/05 14:03:16 rschmidt Exp $ (C) Marvell.";
#endif
...
int		Port)		/* Port Index (MAC_1 + n) */
{
	...
	if (pAC->GIni.GICopperType) {
		...
		if ((LinkPartAb & PHY_ANE_LP_CAP) == 0) {
			...
			SK_ERR_LOG(pAC, SK_ERRCL_HW, SKERR_HWI_E025, SKERR_HWI_E025MSG);
#endif
